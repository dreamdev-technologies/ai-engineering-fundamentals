...
2. Write the goal prompt as a pair. It needs three parts: the goal, the constraints, and the checks the agent must run itself. Start from this and change what you disagree with:
   ```
