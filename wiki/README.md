...
1. **Raw sources.** The code under `src/`, the stories under `activities/`, anything else in version control. Nobody edits these to make the wiki right; the wiki points at them.
