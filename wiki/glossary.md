...
- **Archetype.** A test builder that produces a realistic default domain object, so a test overrides only the value it is about. See `src/TestArchetypes/README.md`.
